  ...
  return (
    <View style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top || Spacing.md }]}>
        ...
        <TranslatedText style={styles.headerTitle}>Notifications</TranslatedText>
        <View style={{ width: 40 }} />
      </View>

      <View style={styles.content}>
        <MaterialIcons name="notifications-off" size={64} color="rgba(255,255,255,0.1)" />
        <TranslatedText style={styles.message}>You're all caught up! No new alerts or notifications at the moment.</TranslatedText>
      </View>
    </View>
  );
}
